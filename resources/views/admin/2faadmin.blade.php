    ...
    <div id="blogempty">
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <p class="text-center">Please Enter Two Facotor Varification code here... We sent code to email : {{ substr(auth()->guard('admin')->user()->email, 0, 5) . '******' . substr(auth()->guard('admin')->user()->email,  -2) }}</p>
                            <p class="text-center">If you have not received it!
                            <a class="btn btn-link"  role="button" id="myBtn"  href="{{ route('2faadmin.resend') }}">Click here</a></p>
        ...
        success:function(result){
           ...
           if(result.data.status == 'error'){
            ...
            var code = $("#code").val('');
               ...
               //}else
                if(result.data == 'Admin'){ //console.log("yes");
                    window.location = "admin_dashboard1";
               }
           }
