...
<x-app-layout>
    <x-slot name="header">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Hello! {{Auth::guard('admin')->user()->name}}  Add New User Here..
            </h2>
    </x-slot>
    <div class="py-12">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <x-auth-card>
                     ...
                     <form  action="/{{app()->getLocale()}}/createnewuser" method="POST" encType="multipart/form-data">
                        @csrf
                        ...
                        <select name="roles" required id="rolepush"  class="form-select block mt-1 w-full" aria-label="Default select example">
                            <option value="">select</option>
                        {{-- @foreac    h($data1 as $data)
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <a type="button" href="/{{app()->getLocale()}}/usermangementajaxviewserverside" class="btn btn-danger ml-4">Cancel</a>
                        </div>
                    </form>
                </x-auth-card>
</div>
