...
@section('content')
  ...
  <div class="flex flex-col">
    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-32">
      ...
      >
        ...
        <label class="block" id="abc">
            <span class="text-gray-700">UserType</span>
            <select name="UserType" class="form-select" >

                <option value="1">Front Role</option>
               <option value="2">Backend Role</option>
            </select>
        </label>
  ...
  <script>
    ...
    if(window.location.href == 'http://localhost:8000/laratrust/roles/create'){
