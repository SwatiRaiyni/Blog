        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="post"  action="/{{app()->getLocale()}}/editpost" encType="multipart/form-data">
                        @csrf
                        <div class="col-sm-6 m-3">
                            ...
                            {{-- @if(Auth::user()->UserType == 1)
                                <a type="button" href="/userpost1" class="btn btn-danger">Cancel</a>
                            @else --}}
                                <a type="button" href="/{{app()->getLocale()}}/user_blog" class="btn btn-danger">{{__('msg.cancel')}}</a>
                            {{-- @endif --}}
                        </div>
                    </form>
            </div>
